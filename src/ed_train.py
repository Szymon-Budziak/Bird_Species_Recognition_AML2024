...
if __name__ == "__main__":
    ...
    train_dataset = BirdDataset(train_data.iloc[train_indices], "./data/train_images", attributes_tensor, transform=train_transform)
    val_dataset = BirdDataset(train_data.iloc[val_indices], "./data/train_images", attributes_tensor, transform=val_transform)
